...
try:
    ...
    sync_redis_client = redis.Redis(unix_socket_path=socket_path, decode_responses=True, db=1)
    async_redis_client = aioredis.Redis(unix_socket_path=socket_path,decode_responses=True, db=1)
except EnvError:
