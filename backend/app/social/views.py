...
from app.deps import BackgroundDep, DbSession, SocialServiceDep
...
async def remove_friend(
    ...
    await service.delete_friend(background, session, current_user_id=user.id, target_id=target_id)
...
async def send_friend_request(
    ...
    await service.create_request(background, session, user.id, target_id)
...
async def cancel_friend_request(
    ...
    await service.delete_request(background, session, user.id, target_id)
...
async def accept_friend_request(
    ...
    await service.accept_request(background, session, target_id, user.id)
...
async def reject_friend_request(
    ...
    await service.delete_request(background, session, target_id, user.id)
