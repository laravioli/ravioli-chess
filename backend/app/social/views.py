...
def create_social_api_router(env: Env):
    ...
    async def list_my_friends(
        ...
        return await env.social.list_friendship(session, user.id, status=FriendshipStatus.accepted)
    ...
    async def list_friends(
        ...
        return await env.social.list_friendship(
            session, target_id, status=FriendshipStatus.accepted
        )
    ...
    async def list_friend_request(
        ...
        return await env.social.list_friendship(session, user.id, status=FriendshipStatus.pending)
    ...
    async def send_friend_request(
        ...
        await env.social.create_request(background, session, user.id, target_id)
    ...
    async def cancel_friend_request(
        ...
        await env.social.delete_request(background, session, user.id, target_id)
    ...
    async def accept_friend_request(
        ...
        await env.social.accept_request(background, session, target_id, user.id)
    ...
    async def reject_friend_request(
        ...
        await env.social.delete_request(background, session, target_id, user.id)
